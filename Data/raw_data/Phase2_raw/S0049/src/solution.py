...
def _is_friday(day: str) -> bool:
    ...
    if normalized[:3].lower() == "fri":
        return True

    try:
        return date.fromisoformat(normalized).weekday() == 4
    except ValueError: 
        return False
...
def suggest_slots(
    ...
    Args:
        ...
        day: Day label/date string (e.g., "Fri" or "2026-02-06")
