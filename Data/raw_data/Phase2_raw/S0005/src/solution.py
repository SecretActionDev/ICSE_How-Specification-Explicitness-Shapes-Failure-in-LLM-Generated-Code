...
LUNCH_START = "12:00"
LUNCH_END = "13:00"
FRIDAY_LAST_START = "15:00"  # new requirement: no meeting start after 15:00 on Fridays
...
def suggest_slots(
    ...
    Constraints:
      ...
      - No meeting may start during lunch (12:00Р13:00)
    ...
    # Friday restriction
    if day.lower() == "friday":
        last_start = _to_minutes(FRIDAY_LAST_START)
    else:
        last_start = day_end
    ...
    def overlaps_busy(start: int) -> bool:
        ...
        # must satisfy Friday last start restriction
        if start > last_start:
            return True
