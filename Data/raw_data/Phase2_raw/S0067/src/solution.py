...
def is_allocation_feasible(
    ...
    given the available resources, while leaving at least
    one unit of each resource unallocated.
    """
    ...
    for req_idx, req in enumerate(requests):
        ...
        for key, value in req.items():
            ...
            if value > remaining[key] - 1:  # Must leave at least 1 unit
                return False
            remaining[key] -= value

    # Ensure all resources have at least 1 unit remaining
    if any(amount < 1 for amount in remaining.values()):
        return False
