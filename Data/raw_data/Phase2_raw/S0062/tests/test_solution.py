...
def test_friday_rule_blocks_starts_after_1500_with_day_name():
    slots = suggest_slots([], meeting_duration=30, day="Fri")
    assert "15:15" not in slots
    assert "16:00" not in slots
    assert "15:00" in slots  # allowed rule says "after 15:00"

def test_friday_rule_blocks_starts_after_1500_with_date():
